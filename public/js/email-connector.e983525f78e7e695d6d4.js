...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.shape.attr({
      ...
      image: { 'xlink:href': __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"icon.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) }
    });
...
var implementation = 'processmaker-social-email-send';
var nodeId = 'processmaker-connectors-social-email-send';
...
ProcessMaker.EventBus.$on('modeler-init', function (modeler) {
    ...
    try {
        for (var _iterator = nodeTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            modeler.registerNode(node, function () {
                return node.id;
            });
        }
    } catch (err) {
